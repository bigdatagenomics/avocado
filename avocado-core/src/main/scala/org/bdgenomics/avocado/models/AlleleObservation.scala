...
case class AlleleObservation(override val pos: ReferencePosition,
                             ...
                             firstOfPair: Boolean,
                             offsetInRead: Int,
                             distanceToNearestReadInsertion: Option[Int],
                             distanceToNearestReadDeletion: Option[Int],
                             distanceFromBeginningClippedRegion: Option[Int],
                             distanceFromEndClippedRegion: Option[Int],
                             clippedBasesReadStart: Int,
